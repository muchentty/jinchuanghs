		...
		<view class="reserve-warp">
			<view class="reserve-item">
				...
				<view class="rerse-right">
					<input v-model="person" placeholder="请填写预约人" />
			...
			<view class="reserve-item">
				...
				<view class="rerse-right">
					<input v-model="numberPer" placeholder="请填写身份证号" />
					<image class="rerse-img" src="../../static/ic_ri.png"></image>
				</view>
			</view>
			<view class="line"></view>
			...
			<!-- <view class="line"></view>
			<view class="reserve-item">
				<view class="rerse-name">报名课程</view>
				<view class="rerse-right">
					<input placeholder="xxx课程" />
					<image class="rerse-img" src="../../static/ic_ri.png"></image>
				</view>
			</view> -->
		</view>
		...
		methods: {
			...
			submit(){
				if(this.person == ''){
					...
					this.$request('/api/culture/ordered',{
						culture_id: this.id,
						name: this.person,
						tel: this.phone,
